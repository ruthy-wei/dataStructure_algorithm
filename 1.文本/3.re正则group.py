...
print('###贪婪：',ret_greed)
print('分组group(0)：',ret_greed.group(0))
print('分组group(value1)：',ret_greed.group('value1'))
print('分组group(1)：',ret_greed.group(1))
print('分组group(2)：',ret_greed.group(2))
print('分组group(3)：',ret_greed.group(3))
print('分组group(4)：',ret_greed.group(4))
print('分组groupdict：',ret_greed.groupdict())


ret_no_greed= re.findall(r'a(\d+?)','a23b')
print('###非贪婪：',ret_no_greed)

ret_remove_str= re.sub(r'(\d+?)','','a23b')
print('从字符串删除：',ret_remove_str)